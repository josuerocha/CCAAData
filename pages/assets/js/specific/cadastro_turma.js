...
$('.form_edit').submit(function(event){
	...
	var posting = $.post(url,{codeEdit: codigoValue},function(data,status){
			if(status == 'success'){
				var turmaEditar = JSON.parse(escapeSpecialChars(data));
				document.getElementById("codeHidden").value = turmaEditar.code;
				document.getElementById("select_sala").value = turmaEditar.sala;
				document.getElementById("select_idioma").value = turmaEditar.idioma;
				document.getElementById("horario_turma").value = turmaEditar.horario;
				document.getElementById("desc_turma").value = turmaEditar.descricao;
            }
        }
		);
});
...
function Novo(){
    ...
    document.getElementById("select_sala").value = '';
    document.getElementById("select_idioma").value = '';
    document.getElementById("horario_turma").value = '';
    document.getElementById("desc_turma").value = '';
}